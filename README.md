...
Testes para validar a regra de negócio da API, bem como cada função para certificar que os parâmetros estão obedecidos e assim garantir que não haja duplicidade de registro nem falta dele.</h2>
<br>
...
>>>>>>> 14524d1 (Testes da API beerstock do professor Rodrigo Peléias)
